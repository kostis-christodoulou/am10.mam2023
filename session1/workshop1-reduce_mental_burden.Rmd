...
# On your own: Hopw do countries generate their energy?

We saw in AM01 the[Cross-country Historical Adoption of Technology (CHAT) dataset](https://www.nber.org/research/data/cross-country-historical-adoption-technology) from The National Bureau of Economic Research (NBER). We want to look at the production mix for energy in countries around the world. You have to write a function (AM01 stuff) that takes as argument a country name, and produces a stacked area graph that shows energy mix since 2000. 
...
energy <- vroom::vroom(here::here("data/energy.csv"))
